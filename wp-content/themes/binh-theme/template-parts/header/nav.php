...
<div class="header">
    <div class="header-left">
        ...
        <a href=<?php echo get_site_url() ?>><img
                src="<?php echo get_template_directory_uri() ?>/assets/images/logo.png" class="img-fluid rounded-top"
                alt=""></a>
    </div>
    ...
    <div class="header-right">
        ...
        <div class="line">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/line.png" class="img-fluid rounded-top"
                alt="">
        </div>

        <div class="header-right-guide">
            Hướng dẫn khách hàng
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/icons/chevdown-icon.svg"
                class="img-fluid rounded-top" alt="">
        </div>
        ...
        <div class="header-right-search">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/icons/icon-search.png"
                class="img-fluid rounded-top search-icon" alt="">
        </div>
    </div>
</div>
